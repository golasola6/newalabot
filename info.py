...
API_ID = int(environ.get('API_ID', '98765Y'))
API_HASH = environ.get('API_HASH', 'd9b7b6709876545ed2945fe1bdea13d2')
BOT_TOKEN = environ.get('BOT_TOKEN', "498U9343:EWIODKJJNFRIJFDNKC")
...
USERNAME = environ.get("USERNAME", "https://t.me/Simplifytuber2")
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5965340120').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-10019876543').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-100XXXX')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://buddhu:<db_password>@buddhu.xwhl5.mongodb.net/?retryWrites=true&w=majority&appName=Buddhu")
DATABASE_NAME = environ.get('DATABASE_NAME', "B")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
TOKEN_VERIFICATION = is_enabled(environ.get("TOKEN_VERIFICATION", "False"), False)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/moviesimplyfytuber")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'krownlinks.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '30d9a254e43ca806d4b2daKJH8cf88abe4f62e35b1c')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/bysimplifytuber')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviesimplyfytuber')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/moviesimplyfytuber/5')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Made with ❤️ @LazyDeveloper')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001753267608'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001959232183')).split()]
